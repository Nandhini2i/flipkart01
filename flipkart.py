...
Original file is located at
    https://colab.research.google.com/drive/18r1H7X8sZTIzSa8ZwNg8k8qjsA3xU1Xe
"""
...
data = pd.read_csv('/content/flipkart_data.csv.csv')
data.head()
...
def preprocess_text(texts):
    ...
    for text in texts:
        if isinstance(text, str):  # Check if the text is a string
            ...
            preprocessed_texts.append(str(text))  # Convert non-strings to strings
